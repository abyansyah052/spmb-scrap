...
for i in range(3):
    ...
    with cols1[i]:
        ...
        <div class="school-card">
            ...
            <div style="font-size: 0.85rem; color: #000000;">Simulasi Peringkat Anda:</div>
            <div class="rank-display">#{sch['rank']}</div>
            <div class="total-text">dari <b>{sch['total']}</b> pendaftar aktif</div>
            <div style="font-size: 0.85rem; font-weight: 600; margin-bottom: 12px; color: #000000;">{status_desc}</div>
