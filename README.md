# SPMB Jatim Scraper & Simulasi Peringkat PPDB 2026
...
4. **Grafik Metrik Sekolah**: Perbandingan visual antara Nilai Anda, Rata-rata Sekolah, Nilai Tertinggi, dan Nilai Terendah di masing-masing sekolah.
5. **Tabel Detail & Highlight**: Menampilkan data seluruh siswa pendaftar asli dan menyisipkan baris **"Simulasi Anda"** dengan warna latar khusus sesuai peringkat simulasi Anda.
...
## ☁️ Cara Hosting Gratis di Streamlit Cloud
